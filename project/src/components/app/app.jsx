...
import { getAuthorizationStatus, getFilmsByGenreSelector } from '../../store/selectors';
...
const mapStateToProps = (state) => ({
  ...
  isDataLoaded: !(isCheckoutAuth(getAuthorizationStatus(state)) || getFilmsByGenreSelector(state).length === 0),
});
